...
const CompaintCard = (propsval) => {
  ...
  useEffect(() => {
    axios
      .get("https://complaint-box-backend-v2.onrender.com/pending")
      .then((res) => {
        // set(res.data);
  ...
  const twoCalls = async (id, k) => {
    ...
    await axios
      .put("https://complaint-box-backend-v2.onrender.com/updatedstatus", {
        id,
        state,
      })
      .then((user) => {
  ...
  const addNote = async (id) => {
    ...
    await axios
      .put("https://complaint-box-backend-v2.onrender.com/noteadded", {
        id,
        value,
      })
